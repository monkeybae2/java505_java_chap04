...
//    return 키워드 사용 시 반환되는 값의 데이터 타입은 해당 메서드의 반한 타입과 일치해야 함
...
//    매개변수와 반환값이 모두 존재하는 타입
    public static int divType4(int a, int b) {
        int result = a / b;
        return result;
    }
}
